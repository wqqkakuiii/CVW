...
import (
	_ "chainmaker.org/chainmaker/vm-wasmer/v2/wasmer-go/packaged/lib/darwin-aarch64"
	...
	_ "chainmaker.org/chainmaker/vm-wasmer/v2/wasmer-go/packaged/lib/windows-amd64"
)

...
#define WASMER_VERSION "6.0.1"
#define WASMER_VERSION_MAJOR 6
...
//MODIFIED 新版已经取消了engine这个概念了，新版是没有跟engine相关的接口的，为了避免修改太多我还是保留了相关接口，但是取消掉了新版删除掉的函数的调用比如is_engine_available
...
void wasm_config_set_backend(wasm_config_t *config, enum wasmer_backend_t engine);
...
bool wasmer_is_backend_available(enum wasmer_backend_t backend);

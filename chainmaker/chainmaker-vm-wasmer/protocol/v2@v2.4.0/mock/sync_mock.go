...
func (m *MockSyncService) GetState(with_others bool) (*sync.SyncState, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetState", with_others)
	ret0, _ := ret[0].(*sync.SyncState)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetState indicates an expected call of GetState.
func (mr *MockSyncServiceMockRecorder) GetState(with_others interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetState", reflect.TypeOf((*MockSyncService)(nil).GetState), with_others)
}

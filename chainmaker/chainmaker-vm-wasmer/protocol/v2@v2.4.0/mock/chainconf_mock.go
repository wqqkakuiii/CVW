...
func (m *MockChainConf) SetChainConfig(chainConf *config.ChainConfig) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetChainConfig", chainConf)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockChainConfMockRecorder) SetChainConfig(chainConf interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetChainConfig", reflect.TypeOf((*MockChainConf)(nil).SetChainConfig), chainConf)
}

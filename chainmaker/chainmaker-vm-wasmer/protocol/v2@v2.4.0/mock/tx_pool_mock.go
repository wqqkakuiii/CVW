...
// ReBroadcastTx mocks base method.
func (m *MockTxPool) ReBroadcastTx(txType txpool.TxType, txStage txpool.TxStage) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ReBroadcastTx", txType, txStage)
}

// ReBroadcastTx indicates an expected call of ReBroadcastTx.
func (mr *MockTxPoolMockRecorder) ReBroadcastTx(txType, txStage interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReBroadcastTx", reflect.TypeOf((*MockTxPool)(nil).ReBroadcastTx), txType, txStage)
}

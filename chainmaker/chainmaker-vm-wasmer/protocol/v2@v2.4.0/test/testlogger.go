...
func (l TestLogger) Debug(args ...interface{}) {
	l.t.Logf(DEBUG+ValNoSpace, args)
}
...
func (l TestLogger) Debugw(msg string, keysAndValues ...interface{}) {
	l.t.Logf(DEBUG+msg+ValSpace, keysAndValues...)
}

// Error error log print
// @param args
func (l TestLogger) Error(args ...interface{}) {
	l.t.Logf(ERROR+ValNoSpace+NextLineString, args, debug.Stack())
}
...
func (l TestLogger) Errorf(format string, args ...interface{}) {
	...
	l.t.Logf(ERROR+str+NextLineString, debug.Stack())
}
...
func (l TestLogger) Errorw(msg string, keysAndValues ...interface{}) {
	l.t.Logf(ERROR+msg+ValSpace, keysAndValues...)
}
...
func (l TestLogger) Fatalw(msg string, keysAndValues ...interface{}) {
	l.t.Fatalf(msg+ValSpace, keysAndValues...)
}

// Info info log print
// @param args
func (l TestLogger) Info(args ...interface{}) {
	l.t.Logf(INFO+ValNoSpace, args)
}
...
func (l TestLogger) Infow(msg string, keysAndValues ...interface{}) {
	l.t.Logf(INFO+msg+ValSpace, keysAndValues...)
}
...
func (l TestLogger) Panicw(m string, keysAndValues ...interface{}) {
	msg := fmt.Sprintf(m+ValSpace, keysAndValues...)
	l.t.Log(msg)
	panic(msg)
}
...
func (l TestLogger) Warn(args ...interface{}) {
	l.t.Logf(WARN+ValNoSpace+NextLineString, args, debug.Stack())
}
...
func (l TestLogger) Warnf(format string, args ...interface{}) {
	str := fmt.Sprintf(format, args...)
	l.t.Logf(WARN+str+NextLineString, debug.Stack())
}
...
func (l TestLogger) Warnw(msg string, keysAndValues ...interface{}) {
	l.t.Logf(WARN+msg+ValSpace, keysAndValues...)
}
